console.log('####### > serverRoutes.js ');
// cd documents/oldss/electioncommentsapp
...
router.get('/', controllerIndex.indexHomepage);

router.get('/electioncomment', controllerIndex.getAddNewComment);



router.post('/electioncomment', controllerIndex.requestAddNewComment);
